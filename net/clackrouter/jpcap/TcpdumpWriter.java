// $Id: TcpdumpWriter.java,v 1.3 2005/09/01 15:32:21 danwent Exp $
...
public class TcpdumpWriter 
{
  ...
  public static void appendVNSEthernetPacket(String filename, VNSEthernetPacket ethPacket) throws Exception {
    Timeval tv = new Timeval(0, 0);

    byte[] data = ethPacket.getByteBuffer().array();
    RawPacket rp = new RawPacket(tv, data, 0);
    appendPacket(filename, rp, LITTLE_ENDIAN);
  }
