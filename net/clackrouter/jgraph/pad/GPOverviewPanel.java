...
// DW: note, this class is not used and has been disabled
...
public class GPOverviewPanel
	 ...
	 */
	protected GPOverviewPanel(JGraph g, ClackDocument d) {
/*		originalGraph = g;
	...
	public static JPanel createOverviewPanel(JGraph g, ClackDocument d){
