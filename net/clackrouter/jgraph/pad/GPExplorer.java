...
public class GPExplorer extends JPanel 
	...
	protected transient RouterGraph graph;
	...
	public GPExplorer(RouterGraph graph) {
		setLayout(new BorderLayout());
		this.graph = new RouterGraph(graph.getModel());
		this.graph.setGraphLayoutCache(
			new StatefulGraphLayoutCache(graph,
					                     this.graph.getModel(),
										 this.graph,
										 false,
										 true));
	...
	public static Set getVerticesForEdges(RouterGraph graph, Set edges) {
	...
	public class StatefulGraphLayoutCache extends GraphLayoutCache {
		...
		public StatefulGraphLayoutCache(JGraph graph,
				                        GraphModel model,
										CellViewFactory factory,
				                        boolean ordered,
										boolean partial) {
			super(graph, model, factory, ordered, partial);
