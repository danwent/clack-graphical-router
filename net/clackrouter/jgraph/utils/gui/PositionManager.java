...
public class PositionManager {
	...
	public static void addComponent(Component comp) {
		...
		if (comp instanceof JSplitPane) {
			...
			// use only windows
			if (comp instanceof Window) {  //got rid of: comp instanceof JInternalFrame || 
				// set the old positions to the internal frame
				updateComponent(comp);
	...
	public static void removeComponent(Component comp) {
		...
		if (comp instanceof JSplitPane) {
			...
			// do not set the position for all components
			// use only windows
			if (comp instanceof Window || comp instanceof ClackTab) {  //got rid of: comp instanceof JInternalFrame || 
