...
import net.clackrouter.jgraph.pad.resources.LocaleChangeEvent;
import net.clackrouter.jgraph.pad.resources.LocaleChangeListener;
import net.clackrouter.jgraph.pad.resources.ProperNameProvider;
	...
	public static void updateComponent(Component comp) {
		...
		try {
			if (comp instanceof Frame
				|| comp instanceof Dialog) {   //got rid of: || comp instanceof JInternalFrame
				String title =
