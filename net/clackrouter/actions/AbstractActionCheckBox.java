...
public abstract class AbstractActionCheckBox extends AbstractActionToggle {
	 ...
	 * @param name
	 */
	public AbstractActionCheckBox(ClackFramework graphpad, String name) {
		super(graphpad, name);
	}
	...
	protected Component getMenuComponent(String actionCommand) {
		...
		ClackBarFactory.fillMenuButton(button, getName(), actionCommand);
	...
	protected Component getToolComponent(String actionCommand) {
		...
		abstractButtons.add(button);
		ClackBarFactory.fillToolbarButton(button, getName(), actionCommand);
		return button;
	}
}
