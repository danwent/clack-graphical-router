...
public class EditDelete extends AbstractActionDefault {
	 ...
	 * @param graphpad
	 */
	public EditDelete(ClackFramework graphpad) {
		super(graphpad);
	}
	...
	public void actionPerformed(ActionEvent e) {
			...
			if (cells != null) {
				for(int i = 0; i < cells.length; i++){
					if(cells[i] instanceof ComponentCell){
						ClackComponent comp = ((ComponentCell)cells[i]).getClackComponent();
						// interfaces can't be deleted
