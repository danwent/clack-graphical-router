...
public abstract class AbstractActionList extends AbstractActionDefault {
	 ...
	 * @param name
	 */
	public AbstractActionList(ClackFramework graphpad, String name) {
		super(graphpad, name);
	}
	 ...
	 * @param icon
	 */
	public AbstractActionList(ClackFramework graphpad, String name, Icon icon) {
	...
	public Component[] getMenuComponents() {
		...
		ClackBarFactory.fillMenuButton(menu, getName(), null);
