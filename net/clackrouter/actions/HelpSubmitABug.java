...
public class HelpSubmitABug extends AbstractActionDefault {
	 ...
	 * @param graphpad
	 */
	public HelpSubmitABug(ClackFramework graphpad) {
		super(graphpad);
	}

	/** Opens the help url.
	 * 
	 * <p> <a href="http://www.jgraph.com/trackers/bug.php?op=add">http://www.jgraph.com/trackers/bug.php?op=add</a>.</p>
	 *
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			BrowserLauncher.openURL("http://www.jgraph.com/trackers/bug.php?op=add");
		} catch (Exception ex){
